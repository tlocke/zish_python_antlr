...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("2007-02-23T12:14Z", ZishException()),
        ...
        ("2007-02-23", ZishException()),
        # Error: Must have seconds
        ("2007-02-23T00:00Z", ZishException()),
        # Error: Must have seconds
        ("2007-02-23T00:00+00:00", ZishException()),
        ...
        ("2007-02-23T00:00:00Z", Datetime(2007, 2, 23, tzinfo=Timezone.utc)),
        ...
        ("2007-02-23T20:14:33.Z", Exception()),
        #
        # Null Values
        #
        ("null", None),
        ...
        ('( "hello\rworld!"  )', ZishException()),
        # The exact same set
        ('("hello world!")', ZishException()),
...
'""",
        ...
        ("' VG8gaW5maW5pdHkuLi4gYW5kIGJleW9uZCE== '", ZishException()),
        # ERROR: Padding character within the data.
        ("' VG8gaW5maW5pdHku=Li4gYW5kIGJleW9uZCE= '", ZishException()),
        ...
        ("' dHdvIHBhZGRpbmc_gY2hhcmFjdGVycw= '", ZishException()),
        #
        # Maps
        #
        # An empty Map value
...
@pytest.mark.parametrize(
  ...
  "would_recommend": true,
        ...
        (Datetime(2017, 7, 16, 14, 5, tzinfo=pytz.utc), "2017-07-16T14:05:00Z"),
    ],
)
